...
public class CPAuthProvider implements AuthenticationProvider {
    ...
    public CPAuthProvider(OAuth2AuthorizationService authorizationService,
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        CPAuthToken CPAuthToken = (CPAuthToken) authentication;
        OAuth2ClientAuthenticationToken clientPrincipal = getAuthenticatedClientElseThrowInvalidClient(CPAuthToken);
        RegisteredClient registeredClient = clientPrincipal.getRegisteredClient();
        username = CPAuthToken.getUsername();
        password = CPAuthToken.getPassword();
        ...
        DefaultOAuth2TokenContext.Builder tokenContextBuilder = DefaultOAuth2TokenContext.builder()
                ...
                .authorizationGrant(CPAuthToken);
    ...
    public boolean supports(Class<?> authentication) {
        return CPAuthToken.class.isAssignableFrom(authentication);
    }
